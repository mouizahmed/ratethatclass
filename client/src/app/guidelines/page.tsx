  ...
  return (
    <div className="flex flex-col items-center gap-4 p-8 sm:p-20">
      <div className="max-w-3xl w-full">
        <h1 className="scroll-m-20 text-xl lg:text-2xl font-semibold tracking-tight lg:text-5xl text-center">
          Site Guidelines
        </h1>
      </div>
      <div className="max-w-3xl w-full">
        <p className="leading-7 [&:not(:first-child)]:mt-6 font-bold text-center">
          Please read these site guidelines thoroughly before using this service.
        </p>
      </div>
      <div className="max-w-3xl w-full">
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          If you see a review that you believe violates our Site Guidelines outlined below, please report it and we will
          have it removed.
        </p>
      </div>
      <div className="max-w-3xl w-full">
