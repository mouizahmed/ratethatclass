...
export default function Privacy() {
  return (
    <div className="flex justify-center gap-4 p-8 sm:p-20">
      <div className="flex flex-col gap-4 max-w-3xl">
        <div className="flex justify-center">
          <h1 className="scroll-m-20 text-xl lg:text-2xl font-semibold tracking-tight lg:text-5xl">Privacy Policy</h1>
        </div>

        <div className="flex flex-col gap-4">
          <p className="leading-7">Last updated: February 21, 2025</p>
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Interpretation and Definitions</p>
          <p className="leading-7 font-bold">Interpretation</p>
          <p className="leading-7">
            The words of which the initial letter is capitalized have meanings defined under the following conditions.
            The following definitions shall have the same meaning regardless of whether they appear in singular or in
            plural.
          </p>
          <p className="leading-7 font-bold">Definitions</p>
          <p className="leading-7">For the purposes of this Privacy Policy:</p>
          <ul className="list-disc list-inside">
            ...
            <li>
              ...
              &quot;Our&quot; in this Agreement) refers to Rate That Class.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Rate That Class, accessible from{' '}
              <a href="https://www.ratethatclass.com" rel="external nofollow noopener" target="_blank">
                https://www.ratethatclass.com
              </a>
            </li>
            <li>
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Collecting and Using Your Personal Data</p>
          <p className="leading-7 font-bold text-lg">Types of Data Collected</p>
          <p className="leading-7 font-bold">Personal Data</p>
          <p className="leading-7">
          ...
          <p className="leading-7 font-bold">Usage Data</p>
          <p className="leading-7">Usage Data is collected automatically when using the Service.</p>
          <p className="leading-7">
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Tracking Technologies and Cookies</p>
          <p className="leading-7">
          ...
          <p className="leading-7">We use both Session and Persistent Cookies for the purposes set out below:</p>
          <ul className="list-disc list-inside">
            <li>
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Use of Your Personal Data</p>
          <p className="leading-7">The Company may use Personal Data for the following purposes:</p>
          <ul className="list-disc list-inside">
            <li>
          ...
          <p className="leading-7">We may share Your personal information in the following situations:</p>
          <ul className="list-disc list-inside">
            <li>
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Retention of Your Personal Data</p>
          <p className="leading-7">
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Transfer of Your Personal Data</p>
          <p className="leading-7">
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Delete Your Personal Data</p>
          <p className="leading-7">
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Disclosure of Your Personal Data</p>
          <p className="leading-7 font-bold">Business Transactions</p>
          <p className="leading-7">
          ...
          <p className="leading-7 font-bold">Law enforcement</p>
          <p className="leading-7">
          ...
          <p className="leading-7 font-bold">Other legal requirements</p>
          <p className="leading-7">
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Security of Your Personal Data</p>
          <p className="leading-7">
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Children&apos;s Privacy</p>
          <p className="leading-7">
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Links to Other Websites</p>
          <p className="leading-7">
        ...
        <div className="flex flex-col gap-4">
          <p className="leading-7 font-bold text-xl">Changes to this Privacy Policy</p>
          <p className="leading-7">
